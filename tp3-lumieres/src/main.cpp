...
void FenetreTP::initialiser()
{
    ...
    GLfloat texcoordsTerre[2 * 4 * 6] =
	{
	  ...
	  +0.45, +0.70,       +0.60, +0.70,        +0.45, +0.83,        +0.60, +0.83, // Europe
      +0.25, +0.75,       +0.35, +0.75,        +0.25, +0.85,        +0.35, +0.85, // Québec
	  +0.45, +0.30,       +0.65, +0.30,        +0.45, +0.65,        +0.65, +0.65, // Afrique
	  +0.20, +0.20,       +0.40, +0.20,        +0.20, +0.65,        +0.40, +0.65, // Amérique-Sud
	  +0.80, +0.25,       +0.94, +0.25,        +0.80, +0.45,        +0.94, +0.45, // Australie
	};
