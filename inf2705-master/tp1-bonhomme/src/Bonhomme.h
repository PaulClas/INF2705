...
public:
    ...
    void afficherCorps()
    {
        ...
        matrModel.PushMatrix();{
            ...
            matrModel.Scale( this->taille, this->taille, this->taille * 2 );
    ...
    void afficherTete()
    {
        ...
        matrModel.PushMatrix();{
            ...
            default:
            case 1: // une sphère
                matrModel.Translate( 0, 0, this->taille * 3 );
            ...
            case 2: // la théière
                matrModel.Translate( 0, 0, this->taille * 2 );
    ...
    void afficherAiles()
    {
        ...
        matrModel.PushMatrix();{
            matrModel.Translate( 0, this->taille, this->taille * 2 );
    ...
    void afficherBrasJambes()
    {
        ...
        // les bras
        matrModel.PushMatrix();{
            matrModel.Translate( 0, this->taille + this->longMembre / 2 - this->largMembre, this->taille * 2 - this->longMembre / 2 );
        ...
        matrModel.PushMatrix();{
            ...
            matrModel.Translate( 0, this->taille, 0 );
            matrModel.Rotate( this->angleJambe, 1, 0, 0 );
            matrModel.Translate( 0, 0, -this->longMembre / 2 );
